...
public abstract class AbstractScreen implements Screen {
	...
	public AbstractScreen(Steel game) {
		this.game = game;
	...
	@Override
	public void show() {
		Gdx.app.log(Steel.LOG, "Showing screen: " + getName());
	...
	public void resize(int width, int height) {
		Gdx.app.log(Steel.LOG, "Resizing screen: " + getName() + " to: "
				+ width + " x " + height);
	}
	...
	@Override
	public void hide() {
		Gdx.app.log(Steel.LOG, "Hiding screen: " + getName());
	...
	@Override
	public void pause() {
		Gdx.app.log(Steel.LOG, "Pausing screen: " + getName());
	}

	@Override
	public void resume() {
		Gdx.app.log(Steel.LOG, "Resuming screen: " + getName());
	}

	@Override
	public void dispose() {
		Gdx.app.log(Steel.LOG, "Disposing screen: " + getName());
