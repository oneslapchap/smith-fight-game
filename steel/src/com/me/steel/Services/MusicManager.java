        ...
        Disposable
{
        ...
        TyrianMusic music )
    {
        ...
        // do some logging
        Gdx.app.log( Steel.LOG, "Playing music: " + music.name() );
    ...
    public void stop()
    {
        if( musicBeingPlayed != null ) {
            Gdx.app.log( Steel.LOG, "Stopping current music" );
    ...
    public void setVolume(
        float volume )
    {
        Gdx.app.log( Steel.LOG, "Adjusting music volume to: " + volume );
    ...
    public void dispose()
    {
        Gdx.app.log( Steel.LOG, "Disposing music manager" );
        stop();
    }
}
