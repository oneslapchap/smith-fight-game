...
import com.me.steel.Utils.LRUCache;
import com.me.steel.Utils.LRUCache.CacheEntryRemovedListener;
        ...
        Disposable
{
        ...
        TyrianSound sound )
    {
        ...
        // play the sound
        Gdx.app.log( Steel.LOG, "Playing sound: " + sound.name() );
    ...
    public void setVolume(
        float volume )
    {
        Gdx.app.log( Steel.LOG, "Adjusting sound volume to: " + volume );
    ...
    public void notifyEntryRemoved(
        ...
        Sound value )
    {
        Gdx.app.log( Steel.LOG, "Disposing sound: " + key.name() );
        value.dispose();
    }
    ...
    public void dispose()
    {
        Gdx.app.log( Steel.LOG, "Disposing sound manager" );
